/**@@@+++@@@@******************************************************************
 **
 ** Android Native Interceptor frida script v1.9 Beta hyugogirubato
 **
 ** frida -D "89a90a4" -l "test.js" -f "com.hidive.android"
 **
...
// Custom params
const PACKAGE = "com.hidive.android"; // undefined for intercept everything
const LIBRARIES = ["libnative-lib.so"]; // empty for intercept everything
const INCLUDES = ["picosha", "random_access_iterator_tagE"]; // empty for intercept everything, "^" and/or "$" filter short functions according to regex
